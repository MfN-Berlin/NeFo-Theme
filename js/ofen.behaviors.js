(function ($) {
   ...
   */
  Drupal.theme.prototype.ofenExampleButton = function (path, title) {
   ...
   */
  Drupal.behaviors.ofenExampleBehavior = {
    attach: function (context, settings) {
      ...
      $('.some-selector', context).once('foo', function () {
        ...
        var $anchor = Drupal.theme('ofenExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
